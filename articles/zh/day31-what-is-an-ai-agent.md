...
![图 1：聊天机器人 vs Agent 架构](./images/day31/chatbot-vs-agent.png)
...
![图 2：Agent Loop（ReAct 模式）](./images/day31/agent-loop-react.png)
...
LLM 是推理引擎。它读取观察结果，决定该做什么，并生成行动计划。2026 年，大多数 Agent 使用 GPT-4o、Claude 3.5/4 或 Gemini 2.5 作为核心。模型的选择至关重要——推理能力更强的模型产生更可靠的 Agent。
...
![图 3：AI Agent 自治度谱系](./images/day31/agent-autonomy-spectrum.png)
...
![图 4：AI Agent 时间线](./images/day31/agent-timeline.png)
