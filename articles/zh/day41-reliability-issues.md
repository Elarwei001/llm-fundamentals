...
- **基线合规率很高**：GPT-4o-mini 和 Mistral Large 2 在恶意任务上的 HarmScore 达到 62.5%–82.2%，拒绝率低至 1–22%。即使是 GPT-4o 和 Claude 3.5 Sonnet 这样的前沿模型，虽然拒绝率更高（48–85%），但在未拒绝的情况下仍然执行了有害任务。
