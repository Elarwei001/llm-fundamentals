...
> **🔍 Deep Dive: The Prehistory of SSMs**  
>  
...
> - Albert Gu's PhD thesis: [Modeling Sequences with Structured State Spaces](https://searchworks.stanford.edu/view/14689893) (2022)
> - The S4 paper: [Efficiently Modeling Long Sequences with Structured State Spaces](https://arxiv.org/abs/2111.00396) (2021)
...
*Figure 7: Mamba block pipeline. The Selective SSM (orange block) is the core: B, C, and Δ are dynamically generated from the input.*
